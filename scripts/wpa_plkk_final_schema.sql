...
-- NOTE: Label resmi "Kajian Tarif" (tinjauan_tarif), bukan "Negosiasi Tarif".
-- Adendum flows (harga, layanan_baru) sekarang include kredensialing_ulang.
insert into wpa_pipeline_tahap_config (jenis_pipeline, tahap, urutan, is_wajib, default_sla_days, handler_role, description) values
  ...
  ('pks_baru', 'tinjauan_tarif', 4, true, 7, 'case_manager', 'Kajian tarif vs Bank Tarif acuan'),
  ...
  -- PERPANJANGAN (8 tahap — kredensialing_ulang + tinjauan_tarif conditional)
  ...
  ('perpanjangan', 'kredensialing_ulang', 3, true, 5, 'case_manager', 'Asesmen mandiri/visitasi ulang'),
  ('perpanjangan', 'tinjauan_tarif', 4, false, 5, 'case_manager', 'Conditional: skip jika tarif sama & wajar'),
  ('perpanjangan', 'drafting_pks', 5, true, 5, 'case_manager', 'Auto-clone dari PKS lama'),
  ('perpanjangan', 'approval_kabid', 6, true, 2, 'kepala_bidang', 'Approval Kabid'),
  ('perpanjangan', 'review_legal_rs', 7, true, 5, 'legal_rs', 'Review legal RS'),
  ('perpanjangan', 'tanda_tangan', 8, true, 3, 'kepala_bidang', 'Tanda tangan'),
  
  -- ADENDUM HARGA/TARIF (8 tahap — kredensialing_ulang + tinjauan_tarif wajib)
  ...
  ('adendum_harga', 'kredensialing_ulang', 3, true, 5, 'case_manager', 'Verifikasi ulang kredensial + dokumen pendukung tarif'),
  ('adendum_harga', 'tinjauan_tarif', 4, true, 7, 'case_manager', 'Kajian tarif baru vs Bank Tarif acuan'),
  ('adendum_harga', 'drafting_adendum', 5, true, 5, 'case_manager', 'Draft adendum dari template'),
  ('adendum_harga', 'approval_kabid', 6, true, 2, 'kepala_bidang', 'Approval Kabid'),
  ('adendum_harga', 'review_legal_rs', 7, true, 5, 'legal_rs', 'Review legal RS'),
  ('adendum_harga', 'tanda_tangan', 8, true, 3, 'kepala_bidang', 'Tanda tangan'),
  ...
  ('adendum_layanan_baru', 'ditinjau', 2, true, 2, 'case_manager', 'CM review proposal layanan'),
  ('adendum_layanan_baru', 'kredensialing_ulang', 3, true, 5, 'case_manager', 'Verifikasi kredensial layanan baru'),
  ('adendum_layanan_baru', 'tinjauan_tarif', 4, true, 7, 'case_manager', 'Kajian tarif layanan baru'),
  ('adendum_layanan_baru', 'drafting_adendum', 5, true, 5, 'case_manager', 'Draft adendum dari template'),
  ('adendum_layanan_baru', 'approval_kabid', 6, true, 2, 'kepala_bidang', 'Approval Kabid'),
  ('adendum_layanan_baru', 'review_legal_rs', 7, true, 5, 'legal_rs', 'Review legal RS'),
  ('adendum_layanan_baru', 'tanda_tangan', 8, true, 3, 'kepala_bidang', 'Tanda tangan'),
  ...
  -- PERUBAHAN DATA FASKES (6 tahap — skip kredensialing_ulang & tinjauan_tarif)
...
-- Cleanup: hapus row lama dengan tahap 'negosiasi_tarif' (sudah diganti tinjauan_tarif)
delete from wpa_pipeline_tahap_config where tahap = 'negosiasi_tarif';
